...
from transformer.cross_view_transformer.common import setup_data_module, load_backbone
from pathlib import Path

import imageio

from transformer.cross_view_transformer.visualizations.nuscenes_stitch_viz import NuScenesStitchViz
...
# Our trained VEHICLE/ROAD model path
...
if download_vehicle_model:
    ...
    print(f'Successfully load custom VEHICLE_MODEL from {VEHICLE_CHECKPOINT_PATH}')
...
if download_road_model:
    ...
    print(f'Successfully load custom RODE_MODEL from {ROAD_CHECKPOINT_PATH}')

# print(f'cfg.model.encoder.backbone.pretrained_path : {cfg.model.encoder.backbone.pretrained_weights_path}')
print(f'torch_cuda.is_available(): { torch.cuda.is_available()}') # True
